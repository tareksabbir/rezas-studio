                ...
                <div className="max-w-screen-2xl px-6 md:px-12 mx-auto">
                    <section class="min-h-96 flex justify-center items-center flex-1 shrink-0 bg-gray-100 overflow-hidden shadow-lg rounded-lg relative py-16 md:py-20 xl:py-36">
                        ...
                        <div class="sm:max-w-xl flex flex-col items-center relative p-4">
                            <p class=" text-white text-lg sm:text-xl text-center mb-4 md:mb-8">I Shoot Happiness</p>
                            ...
                            <div class="w-full flex flex-col sm:flex-row sm:justify-center gap-2.5">
                                <Link to='/' class="inline-block bg-indigo-500 hover:bg-indigo-600 active:bg-indigo-700 focus-visible:ring ring-indigo-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">Book Now</Link>

                                <Link to='/' class="inline-block bg-gray-200 hover:bg-gray-300 focus-visible:ring ring-indigo-300 text-gray-500 active:text-gray-700 text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">Take tour</Link>
                            </div>
                        </div>

                    </section>
                    <div class="mt-12 flex flex-col md:flex-row justify-between items-center gap-8">
                        <div class="w-64 h-12 flex border rounded-lg overflow-hidden divide-x">
                            <Link to='/' class="w-1/3 flex justify-center items-center hover:bg-gray-100 active:bg-gray-200 text-gray-500 transition duration-100">Fashion</Link>
                            <Link to='/' class="w-1/3 flex justify-center items-center hover:bg-gray-100 active:bg-gray-200 text-gray-500 transition duration-100">Weeding</Link>
                            <Link to='/' class="w-1/3 flex justify-center items-center hover:bg-gray-100 active:bg-gray-200 text-gray-500 transition duration-100">Family</Link>
                        </div>
                        ...
                        <div class="flex justify-center lg:justify-start items-center gap-4">
                            ...
                            <div class="flex gap-4">
                                <Link to='/' target="_blank" class="text-gray-400 hover:text-gray-500 active:text-gray-600 transition duration-100">
