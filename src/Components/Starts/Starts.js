            ...
            <div className="bg-white py-6 sm:py-8 lg:py-12">
                <div className="max-w-screen-lg px-4 md:px-8 mx-auto">
                    ...
                    <div className="mb-8 md:mb-12">
                        ...
                        <p className="max-w-screen-md text-gray-500 md:text-lg text-center mx-auto">I Create New Perspectives Through The Lens Of Photographic Stories. I love to turn ideas into beautiful things. Storytelling Through Light, EMOTION AND COMPOSITION.</p>
                    </div>
